...
bwa mem -t 8 -M -R '@RG\tID:2024111301\tPL:illumina\tPU:HHV75DSXX.4\tCN:UBern\tLB:BT134-LIB\tSM:BT134'  $REFERENCE $READS_DIR/BT134_R1.fastq.gz $READS_DIR/BT134_R2.fastq.gz | samtools sort -@8 -m 5G  -o BT134.sorted.bam -
